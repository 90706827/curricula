  ...
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        ...
        <el-tag v-permission="['visitor']" class="permission-sourceCode" type="info">
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        ...
        <el-tab-pane v-if="checkPermission(['visitor'])" label="visitor">
          ...
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkPermission(['visitor'])"
          </el-tag>
        </el-tab-pane>

        <el-tab-pane v-if="checkPermission(['admin','visitor'])" label="Admin-OR-visitor">
          Both admin or visitor can see this
          <el-tag class="permission-sourceCode" type="info">
